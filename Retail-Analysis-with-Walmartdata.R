...
write.csv(walmart_store1, file = "walmart_store1.csv")
write.csv(Insight_data, file = "Insight_data.csv")
write.csv(Summarized_View, file = "Summarized_View.csv")
write.csv(walmart_s_month_year, file = "walmart_s_month_year.csv")
write.csv(walmart_s, file = "walmart_s.csv")
write.csv(walmart_q, file = "walmart_q.csv")
